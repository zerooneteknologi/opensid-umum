  ...
  <div class='col-md-12'>
    <div class="callout callout-success update">
      ...
      <p align="justify">
        ...
        rilis untuk melihat daftar perubahan di versi ini. Sangat dianjurkan untuk melakukan pembaruan ke versi terkini,
        karena setiap rilis berisi perbaikan termasuk peningkatan keamanan data sejak versi yang anda gunakan saat ini
        <code>{{ $rilis['current_version'] }}</code>. Petunjuk melakukan pembaruan dapat dilihat di <a
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-book"></i>&nbsp;&nbsp;Catatan Rilis
              <?= config_item('nama_aplikasi') ?> <small class="label label-success">{{ $rilis['latest_version']
                }}</small>
            </h4>
          </div>
