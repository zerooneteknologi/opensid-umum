...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('display/css/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('display/css/templatemo-style.css') }}">    
<!--
...
<body>
    <video autoplay muted loop id="bg-video">
        <source src="{{ asset('display/video/gfp-astro-timelapse.mp4')}}" type="video/mp4">
    </video>
  ...
  <script src="{{ asset('display/js/jquery-3.5.1.min.js') }}"></script>
  <script src="{{ asset('display/js/bootstrap.min.js') }}"></script>
  <script src="{{ asset('display/js/slick.js') }}"></script>
  <script src="{{ asset('display/js/templatemo-script.js') }}"></script>
</body>
</html>